...
def analyze_image(image_url):
    try:
        ...
        # 3) Contenuto troppo piccolo nel 1080x1080
        if content_ratio < 0.18:
            return {
                "ok": True,
                "status": "yellow",
        ...
        # 4) Contenuto troppo rettangolare
        if aspect_ratio < 0.50 or aspect_ratio > 2.0:
            return {
                "ok": True,
                "status": "yellow",
                "reason": "content_too_rectangular",
